...
if __name__ == "__main__":
  ...
  parser.add_argument('--order', type=str, default='ascending', help='order to parse the papers')
  ...
  for i in range(args.start_index, args.max_index, args.results_per_iteration):
    ...
    query = 'search_query=%s&sortBy=lastUpdatedDate&sortOrder=%s&start=%i&max_results=%i' % (args.search_query,
                                                         args.order, i, args.results_per_iteration)
